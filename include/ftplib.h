...
public:
    ...
    int Pwd(char *path, int max);
		int Nlst(const char *outputfile, const char *path, std::list<char *> * dir_lst);
...
int FtpXfer_get(const char *localfile, const char *path, ftphandle *nControl, accesstype type, transfermode mode);
int FtpXfer_dir(const char *localfile, const char *path, ftphandle *nControl, accesstype type, transfermode mode);
int FtpXfer_nlst(const char *localfile, const char *path, ftphandle *nControl, accesstype type, transfermode mode,std::list<char *> * dir_lst);
...
int FtpRead_dir(void *buf, int max, ftphandle *nData);
int FtpRead_nlst(void *buf, int max, ftphandle *nData,std::list<char *> * dir_lst);
    ...
    int FtpAccess_get(const char *path, accesstype type, transfermode mode, ftphandle *nControl, ftphandle **nData);
